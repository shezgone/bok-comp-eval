...
the in-context surface forms by 8--29 percentage points overall and
18--42 percentage points on the multi-key subset (paired McNemar
$p<0.05$ in 5 of 8 comparisons; the remaining three are borderline at
$p\le 0.19$), despite the agents having strictly more data. Disentangling \emph{query generation}

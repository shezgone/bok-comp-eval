...
\begin{table}[t]
\centering
\caption{Paired McNemar exact two-sided binomial tests on 100 discordant
pairs. Cell format: ``$a$--$b$, $p$'' where $a$ wins on $a$ wrong-$b$
right pairs and $b$ wins on $b$ wrong-$a$ right pairs. Bold marks
$p<0.05$.}
\label{tab:mcnemar}
\small
